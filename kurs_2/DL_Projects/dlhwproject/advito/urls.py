...
urlpatterns = [
    ...
    path('adverts/<int:advert_id>/edit/', views.EditAdvert.as_view(), name='delete_advert'),
    path('adverts/<int:advert_id>/delete/', views.AdvertDelete.as_view(), name='delete_advert'),
