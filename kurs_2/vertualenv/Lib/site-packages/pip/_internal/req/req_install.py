...
class InstallRequirement(object):
    ...
    def __init__(
        ...
        # gets stored. We need this to pass to build_wheel, so the profiles
        ...
        # The PEP 517 profiles we should use to build the project
    ...
    def prepare_metadata(self):
        ...
        Under PEP 517, call the profiles hook to prepare the metadata.
